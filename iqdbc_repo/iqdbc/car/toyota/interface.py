from iqdbc.car import Bus, structs, get_safety_config, uds
from iqdbc.car.toyota.carstate import CarState
from iqdbc.car.toyota.carcontroller import CarController
from iqdbc.car.toyota.radar_interface import RadarInterface
from iqdbc.car.toyota.values import Ecu, CAR, DBC, ToyotaFlags, CarControllerParams, TSS2_CAR, RADAR_ACC_CAR, NO_DSU_CAR, \
...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params_iq(stock_cp: structs.CarParams, ret: structs.IQCarParams, candidate, fingerprint: dict[int, dict[int, int]],
    ...
    if ret.enableGasInterceptor:
      ret.iqSafetyFlags |= ToyotaSafetyFlagsIQ.GAS_INTERCEPTOR
