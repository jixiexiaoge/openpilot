...
def _patch_tinygrad_fetch_fw():
  ...
  if not hasattr(helpers, "fetch_fw"):  # absent on the IQ.Pilot fleet tinygrad
    return
...
if __name__ == "__main__":
  ...
  from openpilot.iqpilot.modeld_v2.get_model_metadata import make_metadata_dict
  ...
  out['frame_skip'] = args.frame_skip  # so the runner sizes queues without guessing
