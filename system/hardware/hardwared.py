...
def hardware_thread(end_event, hw_queue) -> None:
  ...
  while not end_event.is_set():
    ...
    allowed_tici_branches = {"release-new", "release-tici", "master-mici", "beta"}
    is_supported_tici_branch = build_metadata.channel_type == "tici" or build_metadata.channel in allowed_tici_branches
    is_unsupported_combo = TICI and HARDWARE.get_device_type() == "tici" and not is_supported_tici_branch
