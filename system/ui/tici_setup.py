...
IQPILOT_INSTALLER_URL = "IQ-Lvbs/release"
...
class Setup(Widget):
  def __init__(self):
    ...
    self._software_selection_iqpilot_button = ButtonRadio("Install IQ.Pilot", self.checkmark, font_size=BODY_FONT_SIZE, text_padding=80)
  ...
  def render_software_selection(self, rect: rl.Rectangle):
    ...
    iqpilot_rect = rl.Rectangle(rect.x + MARGIN, rect.y + TITLE_FONT_SIZE * FONT_SCALE + MARGIN * 2, rect.width - MARGIN * 2, radio_height)
