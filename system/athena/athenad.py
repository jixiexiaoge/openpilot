...
SPRINGER_ATHENA_HOST = os.getenv('ATHENA_HOST', 'wss://athena.konik.ai')
...
def main(exit_event: threading.Event = None):
  ...
  ws_uri = (SPRINGER_ATHENA_HOST if get_frogpilot_toggles().use_konik_server else ATHENA_HOST) + "/ws/v2/" + dongle_id
  api = Api(dongle_id)
