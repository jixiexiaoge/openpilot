...
def save_bootlog():
  ...
  # value can vanish between copytree's listing and the copy. Skip such files
  # instead of raising — the bootlog snapshot is best-effort and must not block boot.
