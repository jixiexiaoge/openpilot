...
class CarStateReceiverGUI:
    ...
    def setup_ui(self):
        ...
        self.create_info_field(system_frame, "网络 IP:", "network_ip")
        ...
        self.create_info_field(system_frame, "车道信息:", "lane_info")
        self.create_info_field(system_frame, "车辆日志:", "log_carrot")
    ...
    def update_car_info(self, event):
        ...
        self.network_ip_var.set(data.get('network_ip', '未知'))
