...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"CarParamsPersistent", PERSISTENT | FROGPILOT_STORAGE},
    {"CarParamsPrevRoute", PERSISTENT},
    {"CarVin", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION},
    {"CompletedTrainingVersion", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"ExperimentalModeConfirmed", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"GitDiff", PERSISTENT},
    {"GithubSshKeys", PERSISTENT | FROGPILOT_STORAGE},
    {"GithubUsername", PERSISTENT | FROGPILOT_STORAGE},
    {"GitRemote", PERSISTENT},
    {"GsmApn", PERSISTENT | FROGPILOT_STORAGE},
    {"GsmMetered", PERSISTENT | FROGPILOT_STORAGE},
    {"GsmRoaming", PERSISTENT | FROGPILOT_STORAGE},
    {"HardwareSerial", PERSISTENT},
    {"HasAcceptedTerms", PERSISTENT | FROGPILOT_STORAGE},
    {"IMEI", PERSISTENT},
    ...
    {"SecOCKey", PERSISTENT | DONT_LOG | FROGPILOT_STORAGE},
    ...
    {"UpdaterAvailableBranches", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"AMapKey1", PERSISTENT | FROGPILOT_STORAGE},
    {"AMapKey2", PERSISTENT | FROGPILOT_STORAGE},
    {"ApiCache_DriveStats", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"AvailableModels", PERSISTENT | FROGPILOT_STORAGE},
    {"AvailableModelsNames", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"CarMake", PERSISTENT | FROGPILOT_STORAGE},
    {"CarModel", PERSISTENT | FROGPILOT_STORAGE},
    {"CarModelName", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"ClassicModels", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"CustomizationLevel", PERSISTENT | FROGPILOT_STORAGE},
    {"CustomizationLevelConfirmed", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"DownloadableColors", PERSISTENT | FROGPILOT_STORAGE},
    {"DownloadableDistanceIcons", PERSISTENT | FROGPILOT_STORAGE},
    {"DownloadableIcons", PERSISTENT | FROGPILOT_STORAGE},
    {"DownloadableSignals", PERSISTENT | FROGPILOT_STORAGE},
    {"DownloadableSounds", PERSISTENT | FROGPILOT_STORAGE},
    {"DownloadableWheels", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"ExperimentalModels", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"GMapKey", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"MapboxPublicKey", PERSISTENT | FROGPILOT_STORAGE},
    {"MapboxSecretKey", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"NavigationModels", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"RadarlessModels", PERSISTENT | FROGPILOT_STORAGE},
    {"RadicalTurtleDrives", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"RadicalTurtleScore", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"RainbowPath", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_VISUALS},
    {"RandomEvents", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_VISUALS},
    {"RecertifiedHerbalistDrives", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"RecertifiedHerbalistScore", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    ...
    {"SecretGoodOpenpilotDrives", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"SecretGoodOpenpilotScore", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    ...
    {"SteerFrictionStock", PERSISTENT | FROGPILOT_STORAGE},
    {"SteerLatAccel", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"SteerLatAccelStock", PERSISTENT | FROGPILOT_STORAGE},
    {"SteerKP", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"SteerKPStock", PERSISTENT | FROGPILOT_STORAGE},
    {"SteerRatio", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"SteerRatioStock", PERSISTENT | FROGPILOT_STORAGE},
    ...
    {"UseFrogServer", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_OTHER},
    ...
    {"WD40Drives", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"WD40Score", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
