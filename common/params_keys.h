...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    // mapd v2 settings — reverted from merge 353be8b (re-add by hand with mapd v2):
    ...
    // mapd v2 curve-speed controllers — reverted from merge 353be8b (re-add by hand with mapd v2):
    // {"MapCurveSpeedController", {PERSISTENT | BACKUP, BOOL, "0"}},
    // {"VisionCurveSpeedController", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"SpeedCameraControl", {PERSISTENT | BACKUP, BOOL, "0"}},
