...
from openpilot.selfdrive.frogpilot.frogpilot_modeld.constants import ModelConstants, Plan, Meta
...
def fill_model_msg_base(msg: capnp._DynamicStructBuilder, net_output_data: dict[str, np.ndarray], publish_state: PublishState,
...
def fill_model_msg_throttle(extended_msg: capnp._DynamicStructBuilder,
