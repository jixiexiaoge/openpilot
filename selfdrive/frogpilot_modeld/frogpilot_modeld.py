...
from openpilot.selfdrive.frogpilot_modeld.fill_model_msg import fill_model_msg_base, fill_model_msg_throttle, PublishState
...
class ModelStateBase:
  ...
  def __init__(self, context: CLContext, model: str):
    ...
    metadata_path = Path(__file__).parent / 'selfdrive/classic_modeld/models/supercombo_metadata.pkl'
