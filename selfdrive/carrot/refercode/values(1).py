...
class CarControllerParams:
  ...
  STEER_STEP = 1
  STEER_MAX = 980
  STEER_ERROR_MAX = 4000     # max delta between torque cmd and torque motor 改过
...
class CAR(Platforms):
  CHANGAN_Z6 = ChanganPlatformConfig(
    ...
    CarSpecs(mass=2205, wheelbase=2.80, steerRatio=15, tireStiffnessFactor=0.6),
  )#改过
...
# These cars have non-standard EPS torque scale factors. All others are 85 原73
EPS_SCALE = defaultdict(lambda: 85)
