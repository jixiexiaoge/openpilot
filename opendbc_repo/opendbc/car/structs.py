...
class IQCarParams:
  ...
  neuralNetworkFeedForward: 'IQCarParams.NeuralNetworkFeedForward' = field(default_factory=lambda: IQCarParams.NeuralNetworkFeedForward())

  @auto_dataclass
  class NeuralNetworkFeedForward:
    model: 'IQCarParams.NeuralNetworkFeedForward.Model' = field(default_factory=lambda: IQCarParams.NeuralNetworkFeedForward.Model())
