...
struct Event {
  ...
  union {
    ...
    lateralManeuverPlan @162 :LateralManeuverPlan;
    ...
    customReservedState107 @107 :Custom.IQState;
    customReservedModelManager108 @108 :Custom.IQModelManager;
    customReservedPlan109 @109 :Custom.IQPlan;
    customReservedEvents110 @110 :Custom.IQOnroadEvent;
    customReservedCarParams111 @111 :Custom.IQCarParams;
    customReservedCarControl112 @112 :Custom.IQCarControl;
    customReservedBackupManager113 @113 :Custom.IQBackupManager;
    customReservedCarState114 @114 :Custom.IQCarState;
    customReservedLiveData115 @115 :Custom.IQLiveData;
    customReservedModel116 @116 :Custom.IQModelDataV2;
    backupManagerK3 @151 :Custom.IQBackupManager;
    iqNavState @150 :Custom.IQNavState;
    iqState @152 :Custom.IQState;
    iqModelManager @153 :Custom.IQModelManager;
    iqPlan @154 :Custom.IQPlan;
    iqOnroadEvents @155 :Custom.IQOnroadEvent;
    iqCarParams @156 :Custom.IQCarParams;
    iqCarControl @157 :Custom.IQCarControl;
    iqCarState @158 :Custom.IQCarState;
    iqLiveData @159 :Custom.IQLiveData;
    iqModelDataV2 @160 :Custom.IQModelDataV2;
    iqNavRenderState @161 :Custom.IQNavRenderState;
    ...
    # mapd v2 events reverted from merge 353be8b — reserved placeholders hold the ordinals so the
    # union stays hole-free. To re-add mapd v2 by hand, swap these back to:
