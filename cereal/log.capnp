...
struct Event {
  ...
  union {
    ...
    customReservedDriveModel116 @116 :Custom.IQDriveModelData;
    ...
    iqCarState @159 :Custom.IQCarState;
    iqLiveData @160 :Custom.IQLiveData;
    iqDriveModelData @161 :Custom.IQDriveModelData;
    iqNavRenderState @163 :Custom.IQNavRenderState;
    iqLiveLocation @164 :Custom.IQLiveLocation;
